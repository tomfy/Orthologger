...
my $taxon_groups = {
  ...
  '23_dicots' => {
                    ...
                    '12_AM_monocots' => { # These are the 8 AM monocots in the 50-species analysis Sept. 2014
                                         # + a few more
  ...
  '14_monocots' => { # These are the monocots in the 50-species analysis Sept. 2014
                                         ...
                                         'Triticum_urartu' => 1,
                                         'Hordeum_vulgare' => 1,
                    'Spirodela_polyrhiza' => 1, # one r is correct polyrrhiza is an 'orthographical variant'
                    'Zostera_marina' => 1,
                                        }
                   };
...
my $x23_dicot_species_count = 0;
my $x14_monocot_species_count = 0;
      for (@species) {
 ...
 $x23_dicot_species_count++ if(exists $taxon_groups->{'23_dicots'}->{$_});
         $x14_monocot_species_count++ if(exists $taxon_groups->{'14_monocots'}->{$_});
      }
 print "$id   $AM_dicot_species_count  $AM_monocot_species_count   $x23_dicot_species_count  $x14_monocot_species_count \n";
   }
