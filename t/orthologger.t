...
my $Orthologger_obj = Orthologger->new( {'gene_tree' => $gene_tree, 'species_tree' => $species_tree, 'reroot_method' => 'mindl'} );
...
#print "Got ortholog result string:\n", $ortholog_result_string, "\n";
...
is($ortholog_result_string, $expected_ortholog_result_string, 'Check ortholog result string agrees with expectation.');
